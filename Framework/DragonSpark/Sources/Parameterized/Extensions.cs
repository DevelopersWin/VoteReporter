...
namespace DragonSpark.Sources.Parameterized
{
	...
	{
		public static T GetUsing<T>( this IParameterizedSource<Type, object> @this ) => (T)@this.Get( typeof(T) );
		// public static T GetFrom<T>( this IParameterizedSource<Type, T> @this ) => @this.Get( typeof(T) );
