...
namespace DragonSpark.Extensions
{
	...
	{
		public static TValue TryGet<TKey,TValue>( this IDictionary<TKey,TValue> target, TKey key, Func<TValue> defaultValue = null ) => !Equals( default(TKey), key  ) && target.ContainsKey( key ) ? target[ key ] : defaultValue.With( x => x() );
