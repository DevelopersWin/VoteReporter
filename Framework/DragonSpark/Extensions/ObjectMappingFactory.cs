...
namespace DragonSpark.Extensions
{
	...
	{
		public static ISource<ObjectMappingFactory<T>> Default { get; } = new Scope<ObjectMappingFactory<T>>( Factory.Global( () => new ObjectMappingFactory<T>( Activator.Instance.Get() ) ) );
