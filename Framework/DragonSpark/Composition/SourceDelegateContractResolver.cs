...
namespace DragonSpark.Composition
{
	public sealed class SourceDelegateContractResolver : SpecificationParameterizedSource<CompositionContract, CompositionContract>
	{
		...
		public SourceDelegateContractResolver( [OfSourceType]Type sourceDelegateType, Func<Type, Type> resultTypeLocator ) : 
			base( TypeAssignableSpecification<Delegate>.Default.And( GenericTypeAssignableSpecification.Defaults.Get( sourceDelegateType ) ).Project<CompositionContract, Type>( contract => contract.ContractType ).ToSpecificationDelegate(), new Inner( resultTypeLocator ).Get ) {}
