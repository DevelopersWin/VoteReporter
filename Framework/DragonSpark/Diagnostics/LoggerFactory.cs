...
namespace DragonSpark.Diagnostics
{
	public sealed class LoggerFactory : DecoratedParameterizedSource<object, ILogger>
	{
		...
		{
			public static IParameterizedScope<Serilog.LoggerConfiguration, ILogger> Implementation { get; } = new Factory().Accept( ValidatedCastCoercer<Serilog.LoggerConfiguration, LoggerConfiguration>.Default ).ToScope();
			Factory() {}
