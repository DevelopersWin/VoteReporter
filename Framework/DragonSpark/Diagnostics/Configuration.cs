...
{
	public class MinimumLevelConfiguration : ParameterizedConfiguration<LogEventLevel>
	{
	...
	public class ProfilerLevelConfiguration : ParameterizedConfiguration<LogEventLevel>
	{
