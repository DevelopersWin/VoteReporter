...
namespace DragonSpark.Aspects.Validation
{
	static class Defaults
	{
		...
		public static IEnumerable<ValueTuple<TypeAdapter, Func<object, IParameterValidationAdapter>>> Factories { get; } = Definitions.SelectTypes().AsAdapters().Tuple( AdapterSources.ToArray() );
