...
namespace DragonSpark.Runtime
{
	public static class Extensions
	{
		...
		{
			var method = @this.GetType().Adapt().GetMappedMethods( interfaceType ).Introduce( methodName, tuple => tuple.Item1.InterfaceMethod.Name == tuple.Item2 ).Only().MappedMethod;
