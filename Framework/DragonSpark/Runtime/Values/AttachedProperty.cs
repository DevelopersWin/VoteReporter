...
namespace DragonSpark.Runtime.Values
{
	public static class AttachedPropertyExtensions
	{
		...
		public static Assignment<PropertyAssignment<T1, T2>, T1, T2> Assignment<T1, T2>( this IAttachedProperty<T1, T2> @this, T1 first, T2 second ) where T1 : class => 
			new Assignment<PropertyAssignment<T1, T2>, T1, T2>( new PropertyAssignment<T1, T2>( @this ), Assignments.From( first ), new Value<T2>( second ) );
	}
