...
namespace DragonSpark.Runtime.Specifications
{
	public static class SpecificationExtensions
	{
		...
		public static ISpecification<T> ToAny<T>( this IEnumerable<ISpecification> @this ) => new AnySpecification( @this.Fixed() ).Wrap<T>();
		...
		public static ISpecification<T> Wrap<T>( this ISpecification @this, Func<T, object> projection ) => new BoxedSpecification<T>( @this, projection );
	}
}