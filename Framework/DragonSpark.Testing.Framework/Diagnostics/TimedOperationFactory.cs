...
namespace DragonSpark.Testing.Framework.Diagnostics
{
	public sealed class TimedOperationFactory : DragonSpark.Diagnostics.Logging.TimedOperationFactory
	{
		...
		public static IParameterizedSource<MethodBase, IDisposable> Default { get; } = new TimedOperationFactory().With( AssignedSpecification<Action<string>>.Default.Fixed( Output.Default.Get ) );
