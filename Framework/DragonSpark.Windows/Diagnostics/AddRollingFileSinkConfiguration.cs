...
namespace DragonSpark.Windows.Diagnostics
{
	public class AddRollingFileSinkConfiguration : AddFormattableSinkConfigurationBase
	{
		...
		[UsedImplicitly]
		public AddRollingFileSinkConfiguration( string outputTemplate, long fileSizeLimitBytes, int retainedFileCountLimit, LogEventLevel restrictedToMinimumLevel ) : base( restrictedToMinimumLevel )
		{
