...
namespace DragonSpark.Windows.Markup
{
	...
	{
		public static IParameterizedSource<IServiceProvider, IMarkupProperty> Default { get; } = new FieldInfoMarkupPropertyFactory().With( Specification<object, FieldInfo>.Default );
